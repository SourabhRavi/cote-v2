...
export type StorageHash =
  StorageHashBase<'5d0df173f8f4cb2c8822de277c900d1cffc803433be294a5e0e4006e1c8666e6'>;
export type ExecutionHash =
  ExecutionHashBase<'d8569c817ac57c05d10c22f3f774edaedadaf12e6126449fd3bbfba8cbfaf829'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly Workspace: {
      readonly id: Char<36>;
      readonly name: CodecTypes['pg/text@1']['output'];
      readonly createdByUserId: Char<36>;
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    };
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly ChannelMember: {
      readonly id: CodecTypes['sql/char@1']['input'];
      readonly channelId: CodecTypes['sql/char@1']['input'];
    ...
    readonly Workspace: {
      readonly id: CodecTypes['sql/char@1']['input'];
      readonly name: CodecTypes['pg/text@1']['input'];
      readonly createdByUserId: CodecTypes['sql/char@1']['input'];
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['input'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['input'];
    };
    readonly WorkspaceInvitation: {
        ...
        readonly entries: {
          readonly table: {
              ...
              foreignKeys: readonly [
                {
                  ...
                  readonly name: 'Channel_workspaceId_fKey';
                },
              ];
            };
            readonly ChannelMember: {
              ...
              indexes: readonly [
                {
                  readonly name: 'ChannelMember_userId_channelId_key_51e51f8c';
                  readonly prefix: 'ChannelMember_userId_channelId_key';
                  readonly columns: readonly ['userId', 'channelId'];
                  readonly unique: true;
                },
                {
                  readonly name: 'ChannelMember_userId_idx_a489d58a';
                  readonly prefix: 'ChannelMember_userId_idx';
                  readonly columns: readonly ['userId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'ChannelMember_channelId_idx_166d3598';
                  readonly prefix: 'ChannelMember_channelId_idx';
              ...
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'ChannelMember';
                    readonly columns: readonly ['userId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
                  ...
                  readonly name: 'ChannelMember_userId_fKey';
                },
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                  ...
                  readonly name: 'ChannelMember_channelId_fKey';
                },
              ];
            };
            readonly Message: {
              ...
              indexes: readonly [
                {
                  readonly name: 'Message_channelId_idx_166d3598';
                  readonly prefix: 'Message_channelId_idx';
                  readonly columns: readonly ['channelId'];
                  readonly unique: false;
                },
                {
              ...
              foreignKeys: readonly [
                {
                  ...
                  readonly name: 'Message_channelId_fKey';
                },
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                  ...
                  readonly name: 'Message_authorId_fKey';
                },
              ];
            };
            readonly Session: {
            ...
            readonly Workspace: {
              ...
              indexes: readonly [
                {
                  readonly name: 'Workspace_createdByUserId_idx_93e8a540';
                  readonly prefix: 'Workspace_createdByUserId_idx';
              ...
              foreignKeys: readonly [
                {
                  ...
                  readonly name: 'Workspace_createdByUserId_fKey';
                },
              ];
            };
            readonly WorkspaceInvitation: {
              ...
              indexes: readonly [
                {
                  readonly name: 'WorkspaceInvitation_workspaceId_userEmail_key_42b21e23';
                  readonly prefix: 'WorkspaceInvitation_workspaceId_userEmail_key';
                  readonly columns: readonly ['workspaceId', 'userEmail'];
                  readonly unique: true;
                },
                {
              ...
              foreignKeys: readonly [
                {
                  ...
                  readonly name: 'WorkspaceInvitation_workspaceId_fKey';
                },
              ];
            };
            readonly WorkspaceMember: {
              ...
              indexes: readonly [
                {
                  readonly name: 'WorkspaceMember_userId_workspaceId_key_fa32762a';
                  readonly prefix: 'WorkspaceMember_userId_workspaceId_key';
              ...
              foreignKeys: readonly [
                {
                  ...
                  readonly name: 'WorkspaceMember_userId_fKey';
                },
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                  ...
                  readonly name: 'WorkspaceMember_workspaceId_fKey';
                },
              ];
            };
          };
          readonly valueSet: {
            readonly InvitationStatus: {
              ...
              readonly values: readonly ['invited', 'accepted', 'declined'];
            };
            readonly Role: {
              readonly kind: 'valueSet';
